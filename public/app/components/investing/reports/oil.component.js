(function() {
	...
	module.component("oilPage", {
		templateUrl: "/app/components/investing/reports/oil.component.html",
		controllerAs: "vm",
	...
	function controller(api, $window, $interval){
		...
		function cacheArticlesNextSet(response){
			vm.articlesNextSet = response.data;
			vm.getArticlesText();
		}
